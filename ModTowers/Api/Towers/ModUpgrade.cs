...
public abstract class ModUpgrade : NamedModContent
{
    ...
    /// </summary>
    protected virtual void AssignToModTower()
    {
    ...
    /// </summary>
    protected virtual string Portrait => GetType().Name + "-Portrait";
    ...
    /// </summary>
    protected virtual SpriteReference IconReference => GetSpriteReferenceOrNull(Icon);
    ...
    /// </summary>
    protected abstract ModTower Tower { get; }
...
{
    /// <inheritdoc />
    protected override ModTower Tower => GetInstance<T>();
}