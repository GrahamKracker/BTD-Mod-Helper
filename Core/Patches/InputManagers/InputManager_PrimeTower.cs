...
internal class InputManager_PrimeTower
{
    ...
    internal static void Postfix(InputManager __instance)
    {
        ...
        TaskScheduler.ScheduleTask(() => { ModHelper.PerformHook(mod => mod.OnTowerGraphicsCreated(__instance.placementModel, graphics)); }, waitCondition: () => __instance.placementGraphics?.Count > 0);
    }
}